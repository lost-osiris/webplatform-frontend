              ...
              <div className="col-lg-8">
                  ...
                  <div className="col-lg-6">
                    <div className="row">
                      ...
                      <div className="col-lg-9">
                        <Input value={this.props.job.name}
                      ...
                      <div className="col-lg-6">
                          ...
                          <div className="col-lg-12">
                            <div className="toggle-switch toggle-switch-demo">
                              <input value={this.props.job.interval.ends.mode}
                                type="checkbox" onChange={() => this.props.handleToggle('never')}
                                disabled={this.props.disabled.showInterval}
                        ...
                        <div className="row">
                          <div className="col-lg-12">
                            <div className="toggle-switch toggle-switch-demo">
                              <input value={this.props.job.interval.ends.mode}
                                type="checkbox" onChange={() => this.props.handleToggle('occurence')}
                                disabled={this.props.disabled.showInterval}
                ...
                <div className="row">
                  ...
                  <div className="col-lg-4">
                    <div className="row">
                      <div className="col-lg-12">
                        <Input value={this.props.newParam.key}
                    ...
                    <div className="row">
                      <div className="col-lg-12">
                        <Input value={this.props.newParam.value}
                ...
                <div className="card">
                  ...
                  <div className="card-body card-padding">
                    ...
                    <p>
                      ...
                      <b>Set an interval</b>
                      checkbox and selecting the desired interval (e.g. daily, weekly, etc.). Additionally, you can instruct the scheduler to skip a number of intervals between jobs. Scheduled jobs can be given a termination condition as well, which is either a fixed number of iterations or a certain date.
                    </p>
